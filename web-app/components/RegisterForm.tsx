...
export default function RegisterForm() {
  ...
  const onRegisterButton = async (e: React.FormEvent<HTMLButtonElement>) => {
    e.preventDefault();
  ...
  return (        
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden"
      ...
      <div className="w-full p-6 bg-white rounded-md shadow-md lg:max-w-xl">
        <h1 className="text-3xl font-bold text-center text-gray-700">Minecraft SaaS</h1>
        <form className="mt-6">
        <div className="mb-2">
            <label
              htmlFor="username"
          ...
          <div className="mt-2">
            <button onClick={onRegisterButton} className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
              Sign Up
            </button>
          </div>
        </form>
